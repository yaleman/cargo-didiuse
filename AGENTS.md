...
- It accepts either:
  ...
  - the local RustSec advisory database (default: `$CARGO_HOME/advisory-db`).
...
- Call matching is done by:
  ...
  - heuristic method-call detection using known vulnerable method names plus best-effort type matching.
